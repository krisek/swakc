...
RUN cd /tmp; curl https://downloads.mongodb.com/compass/mongosh-2.3.3-linux-x64.tgz --output mongosh-2.3.3-linux-x64.tgz; tar zxf mongosh-2.3.3-linux-x64.tgz; cp mongosh-2.3.3-linux-x64/bin/* /usr/bin; rm -Rf mongosh-2.3.3-linux-x64.tgz mongosh-2.3.3-linux-x64
ENV TERM screen
